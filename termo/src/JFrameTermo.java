            ...
            for (int j = 0; j < 5; j++) {
                ...
                matriz[i][j].addKeyListener(new KeyListener() {
                    ...
                    public void keyPressed(KeyEvent e) {
                        if (e.getKeyCode() == KeyEvent.VK_BACK_SPACE && coluna < 5 && coluna > 0
                                && matriz[linha][coluna].getText().length() == 0) {
                            matriz[linha][coluna - 1].requestFocusInWindow();
                            teclaBackSpacePress = true;
                        } else if (e.getKeyCode() == KeyEvent.VK_BACK_SPACE && coluna == 0
                                || matriz[linha][coluna].getText().length() == 1) {
                            teclaBackSpacePress = true;
                        }
